          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildChatBubble(
                  message:
                      "السلام عليكم، طلبي رقم 5543 لم يصل حتى الآن رغم مرور 3 أيام على الموعد المحدد. هذه المرة الثانية التي تتأخرون فيها!",
                  isMe: false,
                ),
                ...
                _buildChatBubble(
                  message:
                      "وعليكم السلام أستاذ أحمد. نعتذر جداً عن هذا التأخير غير المقصود. قمت بمراجعة النظام حالياً، وتبين أن الشحنة في مرحلة التوزيع النهائي. سأقوم بمنحك كوبون خصم 20% لطلبك القادم كتعويض. هل تود أن أتابع لك مع شركة الشحن مباشرة؟",
                  isMe: true,
                  isAI: true,
                ),
                ...
                _buildChatBubble(
                  message:
                      "لا أريد كوبونات، أريد طلبي الآن. خدمة العملاء لديكم أصبحت سيئة جداً ولن أتعامل معكم مرة أخرى.",
                  isMe: false,
                ),
  ...
  Widget _buildUserInfoCard() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(children: [_buildSentimentDots()]),
          Column(
